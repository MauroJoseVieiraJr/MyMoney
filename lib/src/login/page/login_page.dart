import 'package:app_my_money/src/login/components/register_link.dart';
import 'package:app_my_money/src/shared/colors/app_colors.dart';
import 'package:app_my_money/src/shared/components/app_button.dart';
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: AppButton(
                          action: () {},
                          label: "Login", 
                          //context: this.context, // Pode dar problemas em função dessa linha
                        ),
                      ),
                      GestureDetector(
                        onTap: () {},
